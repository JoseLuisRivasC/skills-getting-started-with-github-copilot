...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball fundamentals and teamwork through drills and games",
    ...
    "Theater Club": {
        "description": "Build acting and stage production skills through creative performances",
